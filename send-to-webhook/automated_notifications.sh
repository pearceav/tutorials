...
# Notify the Slack!!
curl -X POST --data-urlencode "payload={\"channel\": \"#test-notifications\", \"username\": \"Happy Treasure Hunters\", \"text\": \"$payload\", \"icon_emoji\": \":gem:\"}" "$WEBHOOK_URL"
...
sleep 5
curl -X POST --data-urlencode "payload={\"channel\": \"#test-notifications\", \"username\": \"Sad Treasure Hunters\", \"text\": \"$payload\", \"icon_emoji\": \":pirate_flag:\"}" "$WEBHOOK_URL"
echo
